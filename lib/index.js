...
exports['default'] = function () {
	...
	return function (module) {
		...
		module.signals({
			initializeInput: [function (_ref7) {
			...
			addToForm: [getAssociatedForms, function (_ref8) {
			...
			removeFromForm: [getAssociatedForms, function (_ref9) {
			...
			focus: [],
			blur: [getAssociatedForms, makeSurePathIsPresent, function (_ref10) {
...
function getAssociatedForms(_ref11) {
...
function checkIfFormsAreCompleted(_ref12) {
